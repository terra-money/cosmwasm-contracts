use crate::msg::{SpecialQuery, CustomResponse};

use cosmwasm_std::testing::{MockApi, MockQuerier, MockStorage, MOCK_CONTRACT_ADDR};
use cosmwasm_std::{to_binary, Binary, Coin, HumanAddr, SystemResult, ContractResult, OwnedDeps};
...
mod tests {
    ...
    fn custom_querier() {
        ...
        let response: CustomResponse = wrapper.custom_query(&req).unwrap();
