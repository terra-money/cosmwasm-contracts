...
use reflect::msg::{
    CapitalizedResponse, ChainResponse, CustomMsgWrapper, ExecuteMsg, InstantiateMsg,
    OwnerResponse, QueryMsg, RawResponse,
};
...
fn main() {
    ...
    export_schema(&schema_for!(Response<CustomMsgWrapper>), &out_dir);
