...
pub enum ExecuteMsg {
    ...
    ReflectSubCall { msgs: Vec<SubMsg<CustomMsgWrapper>> },
...
pub enum QueryMsg {
    ...
    Chain {
        request: QueryRequest<CustomQueryWrapper>,
    },
...
impl From<CustomMsgWrapper> for CosmosMsg<CustomMsgWrapper> {
    fn from(original: CustomMsgWrapper) -> Self {
